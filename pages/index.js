    ...
    <>
      <nav className="flex bg-[#f5f5f5] px-20 py-5 items-center">
        ...
        <div className="flex gap-3">
          <div>
            <Link href='/login' className="rounded-xl py-2 px-8 w-[110px] font-bold border-2 border-[#10A19D] text-[#10A19D] bg-white">Login</Link>
          </div>
          <div>
            <Link href='/register' className="rounded-xl py-2 px-6  w-[110px] font-bold border-2 border-[#10A19D] text-white bg-[#10A19D]">Sign Up</Link>
          </div>
        </div>
      </nav>
