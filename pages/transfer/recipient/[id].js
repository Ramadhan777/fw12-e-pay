          ...
          <div className="card w-full">
            <div className="card-body py-5">
              <div className="flex flex-col gap-5">
                <div className="grow font-bold text-lg">Transfer Money</div>
                ...
                <form onSubmit={setAmount} className="flex flex-col gap-10">
                  ...
                  <div className="flex flex-col grow gap-10 items-center">
                    <div>
                      <input onChange={limit} className="text-4xl no_arrows text-center focus:outline-none text-[#10A19D] inner-spin-button-hidden" type="number" name="amount" id="amount" placeholder="0.00" />
                    </div>
