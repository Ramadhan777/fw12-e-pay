      ...
      <main className="flex flex-col lg:flex-row px-6 md:px-12 lg:px-16  py-7 bg-[#f5f5f5] lg:h-[580px] gap-5">
        ...
        <div className="flex-[80%] bg-white p-5 h-full overflow-y-auto bg-base-100 rounded-xl shadow-md">
          <div className="flex flex-col gap-3">
            ...
            <div className="grow font-bold text-lg">Detaills</div>
            ...
            <div className="card w-full bg-base-100 shadow-md">
              <div className="card-body p-3 flex flex-row gap-3 items-center">
                <div className="flex flex-col">
                  ...
                  <div className="font-bold">Rp{user.balance - amount}</div>
                </div>
              </div>
            </div>
            <div className="card w-full bg-base-100 shadow-md">
          ...
          <form onSubmit={transfer} className="flex flex-col w-[430px] gap-14">
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`text-center rounded-xl py-3 w-[150px] text-white hover:cursor-point ${pin1 && pin2 && pin3 && pin4 && pin5 && pin6 ? "bg-[#10A19D]" : "bg-[#DADADA]"}`}
                type="submit"
              >
                Continue
              </button>
