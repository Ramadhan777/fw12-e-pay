  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-[40%] px-10 gap-5 items-center overflow-y-auto pt-16 pb-10 bg-[#f5f5f5]">
        <div className="text-2xl font-bold leading-relaxed w-[430px]">Secure Your Account, Your Wallet, and Your Data With 6 Digits PIN That You Created Yourself.</div>
        <div className="leading-relaxed w-[430px]">Create 6 digits pin to secure all your money and your data in e-Pay app. Keep it secret and don’t tell anyone about your e-Pay account password and the PIN.</div>
          ...
          <div className="flex gap-6 mt-5">
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin1 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin1 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input1}
                name="pin1"
                id="pin1"
            ...
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin2 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin2 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input2}
                name="pin2"
                id="pin2"
            ...
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin3 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin3 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input3}
                name="pin3"
                id="pin3"
            ...
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin4 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin4 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input4}
                name="pin4"
                id="pin4"
            ...
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin5 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin5 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input5}
                name="pin5"
                id="pin5"
            ...
            <div className={`bg-white rounded-xl text-center px-1 py-2 border-[1px] ${pin6 ? "border-[#10A19D]" : "border-[#A9A9A9]"}`}>
              <input
                ...
                className={`grow no_arrows w-10/12 border-[#A9A9A9] focus:outline-none text-4xl text-center ${pin6 ? null : "border-b-[1px]"}`}
                type="number"
                ref={input6}
                name="pin6"
                id="pin6"
